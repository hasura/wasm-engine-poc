use schemars::{
    schema::{Schema::Object as SchemaObjectVariant, SchemaObject, SubschemaValidation},
    JsonSchema,
};
...
#[schemars(rename = "OpenDdsMetadata")]
#[serde(untagged)]
pub enum Metadata {
...
mod tests {
    ...
    fn test_metadata_schema() {
        ...
        let schema = schema_for!(super::Metadata);
        write!(
            expected,
            "{}",
