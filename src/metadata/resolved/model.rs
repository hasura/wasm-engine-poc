...
pub enum ModelPredicate {
    UnaryFieldComparison {
        field: FieldName,
        ndc_column: String,
        operator: ndc::models::UnaryComparisonOperator,
    },
    BinaryFieldComparison {
        field: FieldName,
        ndc_column: String,
        operator: ndc::models::BinaryComparisonOperator,
...
) -> Result<ndc::models::UnaryComparisonOperator, Error> {
    match operator.0.as_str() {
        "_is_null" => Ok(ndc::models::UnaryComparisonOperator::IsNull),
...
fn resolve_binary_operator(
    ...
    scalars: &HashMap<&str, ScalarTypeInfo>,
    ndc_scalar_type: &ndc::models::ScalarType,
    subgraph: &str,
) -> Result<
    (
        ndc::models::BinaryComparisonOperator,
        QualifiedTypeReference,
    ),
    Error,
> {
    match operator.0.as_str() {
        "_eq" => {
            ...
            Ok((
                ndc::models::BinaryComparisonOperator::Equal,
        ...
        _ => {
            let argument_ndc_type = &ndc_scalar_type
                ...
                .argument_type;
            Ok((
                ndc::models::BinaryComparisonOperator::Other {
