    ...
    fn build_type_info(
        ...
        match type_id {
            types::TypeId::QueryRoot => Ok(gql_schema::TypeInfo::Object(
                types::query_root::query_root_schema(builder, self)?,
            )),
            types::TypeId::MutationRoot => Ok(gql_schema::TypeInfo::Object(
                types::mutation_root::mutation_root_schema(builder, self)?,
            )),
            ...
            types::TypeId::NodeRoot => Ok(gql_schema::TypeInfo::Interface(
                operations::relay::node_interface_schema(builder, self)?,
            )),
            types::TypeId::ModelArgumentsInput {
                model_name,
                type_name,
            } => types::model_arguments::build_model_arguments_input_schema(
                self, builder, type_name, model_name,
            ),
            types::TypeId::ModelBooleanExpression {
                model_name,
                graphql_type_name,
            } => types::model_filter::build_model_filter_expression_input_schema(
                self,
                builder,
                graphql_type_name,
                model_name,
            ...
            types::TypeId::ScalarTypeComparisonExpression {
                ...
                graphql_type_name,
                operators,
            } => types::model_filter::build_scalar_comparison_input(
                self,
                builder,
                graphql_type_name,
                operators,
            ...
            types::TypeId::ModelOrderByExpression {
                model_name,
                graphql_type_name,
            } => types::model_order_by::build_model_order_by_input_schema(
                self,
                builder,
                graphql_type_name,
                model_name,
            ...
            types::TypeId::OrderByEnumType => {
                types::model_order_by::build_order_by_enum_type_schema(builder)
            }
        }
    }
